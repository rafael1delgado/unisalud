...
class ExternalIncomingSic extends Model
{
    ...
    protected $fillable = ['sic_number', 'sic_number_ges', 'request_date', 'request_time', 'entry_date', 'entry_time',
        'health_service_code', 'establishment_code', 'specialty_code', 'patient_name', 'patient_fathers_family', 'patient_mothers_family', 'patient_document_type', 'ruta_pac',
        'patient_dv', 'patient_document_number', 'patient_sex_indicator', 'patient_birthday', 'patient_address', 'patient_street_type', 'patient_comune_code',
        ...
        'patient_social_name', 'tutor_name', 'patient_email', 'patient_nationality', 'patient_ethnicity', 'patient_marital_status'
    ];

    public function getAgeAttribute()
    {
        return $this->patient_birthday->age;
    }
