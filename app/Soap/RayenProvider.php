...
class RayenProvider
{
    ...
    public static function saveInterconsulta(Interconsulta $interconsulta){
    
        $humanName = new HumanName();
        $humanName->use = 'official';
        $humanName->text = $interconsulta->organizationName;
        $humanName->fathers_family = $interconsulta->specialtyName;
        $humanName->mothers_family = $interconsulta->patientName;
        $humanName->save();
        
        return new Response(true, 'Se agregó interconsulta correctamente.');
    } 
