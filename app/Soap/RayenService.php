...
use SoapFault;
use App\Soap\RayenProvider as Provider;
use App\Soap\Types\Interconsulta;
...
class RayenService
{
    ...
    */
    ...
    /**
     * Guarda y responde si se guardó correctamente.
     *
     * @param string $patientName
     * @param string $specialtyName
     * @param string $organizationName
     * @return \App\Soap\Types\Response
     * @throws SoapFault
     */
    public function setInterconsulta($patientName, $specialtyName, $organizationName)
    {
        $interconsulta = new Interconsulta(1, $patientName, $specialtyName, $organizationName);
        return Provider::saveInterconsulta($interconsulta);
    }
