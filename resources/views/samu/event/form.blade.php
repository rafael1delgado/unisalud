...
<div class="form-row">
    ...
    <fieldset class="form-group col-md-3">
        ...
        <select class="form-control" name="key_id" id="for-key" required>
            ...
            <option 
                value="{{ $key->id }}" 
                {{ old('key_id', (request()->routeIs('samu.event.create')) ? optional($call)->key_id : optional($event)->key_id) == $key->id ? 'selected' : '' }}>
                {{ $key->key }}  - {{ $key->name }}
            </option>
            @endforeach 
        </select>
...
<div class="form-row">
    ...
    <fieldset class="form-group col-md-5">
        ...
        value="{{ old('address', request()->routeIs('samu.event.create') ? optional($call)->address : optional($event)->address )}}">
    </fieldset>
    ...
    <fieldset class="form-group col-md-3">
        ...
        <select class="form-control" name="commune_id" id="for-commune">
            ...
            <option value="{{ $id }}" {{ old('commune_id', request()->routeIs('samu.event.create') ? optional($call)->commune_id : optional($event)->commune_id ) == $id ? 'selected' : '' }}>{{ $name }}</option>
            @endforeach 
        </select>
    </fieldset>
