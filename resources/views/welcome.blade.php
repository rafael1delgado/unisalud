...
<head>
    ...
    <!-- Favicons -->
    @switch(env('APP_ENV'))
        @case('local') <link rel="icon" type="image/vnd.microsoft.icon" href="favicon-local.ico"> @break
        @case('production') <link rel="icon" type="image/vnd.microsoft.icon" href="favicon-production.ico"> @break
    @endswitch
